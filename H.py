...
Holes = [[(16000,20000),(19000,22000),(16000,23000)],[(14000,27000),(15000,28000),(14000,29000)]]
...
for i in range(len(Bc)):
    Bc[i].append(Bc[i][0])
#print("The Bc is",Bc)
#print("Now the Hc is:",Hc)
#print("Now the Pc is:",Pc)
...
def chk_pts(Ac,Zc,Bc,P,Yx,H):
    ...
    for g in range(len(Pb)):
         if not Pb[g] in m:
            F.append(Pb[g])
    #print("The F:",F)
    Pfinal = mini_chk_pts(Yf1,F,Yn,Pb)
    final = []
    for i in Pfinal:
         if not i in final:
                 final.append(i)
