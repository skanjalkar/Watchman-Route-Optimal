...
# Poly = [(12,3),(8,8),(14,8),(9,11),(4,8),(6,5),(2,8.5),(4,11),(0.5,11),(-2,7.5),(2,6),(-3,6),(-2,3),(3,0),(4,2),(8,0),(14,0),(16,2),(15,8),(13,7)]

# Poly = [(20,140),(0,140),(-50,70),(0,0),(20,-20),(40,0),(40,40),\
#     (40,40),(80,40),(80,0),(140,-50),(200,0),(200,60),(150,60),(150,100),\
#     (200,100),(200,140),(160,140),(160,160),(100,160),(100,140),(60,140),(60,160),(20,160)]
'''Poly = [(25,19),(23,19),(21,22),(23,24),(19,28)\
...
def mini_chk_pts(Pb,Pc,P,Yx):
    ...
    while F != []:
        ...
        for a in range(len(Yf1)):               # So this loop is find the guards which guard maximum of the unguarded edges (first case is similar to yf1)
            Yy = []
...
def plt_plot(P,Yn):
    ...
    plt.scatter(Sx,Sy,s = 700,marker = '.',color = 'r')
    End = time.time()
